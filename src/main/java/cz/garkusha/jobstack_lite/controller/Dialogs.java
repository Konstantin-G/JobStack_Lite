...
public class Dialogs {
    ...
    // Create expandable Exception.
        ...
        // add css to dialog.
        alert.getDialogPane().getStylesheets().add(Dialogs.class.getResource(CSS_LOCATION).toExternalForm());
    ...
    public static void connectionError() {
        ...
        dialogPane.getStylesheets().add(Dialogs.class.getResource(CSS_LOCATION).toExternalForm());
